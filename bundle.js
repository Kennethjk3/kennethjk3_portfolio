...
/***/ function(module, exports, __webpack_require__) {
	...
	var Project = __webpack_require__(208);
	var Resume = __webpack_require__(209);
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement('img', { className: 'link-icon', title: 'Github', alt: 'Github', src: 'src/style/img/icons/github.svg' })
	          ),
	          React.createElement(
	            'a',
	            { href: 'https://www.linkedin.com/in/kenneth-kier-09260282' },
	            React.createElement('img', { className: 'link-icon', title: 'LinkedIn', alt: 'LinkedIn', src: 'src/style/img/icons/linkedin.svg' })
	          )
	        ),
	        React.createElement(
	          'div',
	          ...
	          React.createElement(
	            ...
	            React.createElement('img', { className: 'link-icon', title: 'Facebook', alt: 'Facebook', src: 'src/style/img/icons/facebook-square.svg' })
	          ),
	          React.createElement(
	            'a',
	            { href: 'mailto:kennethjk3@gmail.com' },
	            React.createElement('img', { className: 'link-icon', title: 'Gmail', alt: 'Gmail', src: 'src/style/img/icons/mail.svg' })
	          )
	        )
	      )
	    );
