	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('img', { className: 'social-fb', title: 'Facebook', alt: 'Facebook', src: './css/img/icons/facebook-square.svg' })
	        ),
	        React.createElement(
	          'a',
	          { href: 'https://www.linkedin.com/in/kenneth-kier-09260282' },
	          React.createElement('img', { className: 'social-li', title: 'LinkedIn', alt: 'LinkedIn', src: './css/img/icons/linkedin.svg' })
	        )
	      )
	    );
	  }
